...
apt update && apt install python3 python3-requests python3-pip python3-nacl python3-redis -y
...
tmux send-keys -t 0-hub_user_sync "while true; do python3 hub-clone.py https://hub.grid.tf /srv/0-hub_public/users ${DOMAIN}; sleep 10m; done" ENTER
