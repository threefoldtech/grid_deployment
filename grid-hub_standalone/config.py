...
config = {
    ...
    'backend-public-host': "hub.peter.hub.ourworld.tf",
    ...
    'public-website': "https://hub.peter.hub.ourworld.tf",
    ...
    ##  - ./workdir
    ##
    'userdata-root-path': '/public',
    'workdir-root-path': '/workdir',
    ...
    'threebot-privatekey': 'SGIuL55hehDm8YvmP1+rNi3/WgOEID2EOVhGv5zJ0mE=',
    'threebot-appid': 'hub.peter.hub.ourworld.tf',
    'threebot-seed': b'\x86A\xd4Z\x18P\xaa\xfe\xf6\xfc]\x1a=9N\x15\x9f\x0b\xec\x1f\xa0\xde,\x81\x9dKU\xb2L\xben"',
